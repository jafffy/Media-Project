...
#
#	Description:
#	- Classify movie reviews in NAVER, via movie rivew rating.
#	- 0 ~ 3 star -> bad(negative), 8 ~ 10 star -> good(positive)
#	- After classify reviews, construct dictionary of sentiments.
